...
public class SceltaStanzeServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<html>");
		out.println("<head>");
		out.println("<title>Elenco stanze</title>");
		out.println("</head>");
		out.println("<body>");
		out.println("<h1>Elenco stanze</h1>");
		...
		try {
		    ...
		    while (rs.next()) {
		        if (rs.isFirst()) {
		            ...
		            out.println("<caption>Tabella delle stanze dell'edificio</caption>");
		            out.println("<thead>");
